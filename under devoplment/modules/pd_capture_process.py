...
class CaptureProcess:
    ...
    def _init_capture(self):
        ...
        # IMPORTANT: import from pd_capture_backends (standalone) — NOT pd_capture.
        # Under Windows multiprocessing spawn, the subprocess re-imports
        # SERVER.py, and pd_capture depends on server-injected globals (np, cv2,
        # _dxcam, _mss, _vprint, _get_flag_backend). pd_capture_backends is
        # fully self-contained and importable from a fresh interpreter.
        from pd_capture_backends import _create_capture_backend
